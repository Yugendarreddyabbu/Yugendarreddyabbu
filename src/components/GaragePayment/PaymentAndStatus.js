											...
											<table id="example2" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
												<thead>
													...
													<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style={{ width: "192.438px" }}>Vehicle No.</th>
														...
														<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style={{ width: "130.363px" }}>Status</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style={{ width: "130.363px" }}>View</th>
												</tr>
												</thead>
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td>Mercedes</td>
														<td>£33</td>
														<td><i className="btn btn-danger" style={{width:"100%"}}>Not Paid</i></td>
                                            ...
                                            <td> <div className="col-12">
                                                <button className="btn btn-white" style={{ width: "100%", backgroundColor: "#f5f5f5", color: "#000", fontSize: "10px", fontWeight: "500", padding: "10px", whiteSpace: "nowrap", borderRadius: "4px", textAlign: "center",border:"1px solid"}} ><i className="icon icon-View"></i>View</button>
													...
													<td class="sorting_1">BU 9876</td>
														...
														<td>Polo</td>
														<td>£19</td>
														<td><i className="btn btn-success" style={{width:"100%"}}>Paid</i></td>
                                                        
                                            <td> <div className="col-12">
                                            <Link to="/garagesendmail"><a className="btn btn-white" style={{ width: "100%", backgroundColor: "#f5f5f5", color: "#000", fontSize: "10px", fontWeight: "500", padding: "10px", whiteSpace: "nowrap", borderRadius: "4px", textAlign: "center",border:"1px solid"}}><i className="icon icon-View"></i>View</a> </Link>
                                            </div></td>
													</tr>
													<tr role="row" class="odd">
...
export default PaymentAndStatus;